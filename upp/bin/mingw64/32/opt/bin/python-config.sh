...
prefix_build="/c/mingw710/i686-710-win32-dwarf-rt_v5-rev2/mingw32/opt"
...
CFLAGS=$(echo "-O2 -pipe -fno-ident -I/c/mingw710/i686-710-win32-dwarf-rt_v5-rev2/mingw32/opt/include -I/c/mingw710/prerequisites/i686-zlib-static/include -I/c/mingw710/prerequisites/i686-w64-mingw32-static/include -fwrapv -DNDEBUG -D__USE_MINGW_ANSI_STDIO=1" | sed "s#$prefix_build#$prefix_real#")
VERSION="2.7"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
